...
class Server(object):
	...
	def start_election(self):
		logger.info('Server start_election Method')
		self.role = 'candidate'
	...
	def append_entries(self):
		logger.info('Server append_entries Method')
		receipts = self.peers[:]
		while 1:
			receipts = self.peers[:]
	...
	def load(self):
		logger.info('Server load config Method')
	...
	def save(self):
		logger.info('Server save config Method')
